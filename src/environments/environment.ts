...
export const environment = {
   ...
   apiUrl: 'https://leeds-sd-push-bernard.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://leeds-sd-push-bernard.trycloudflare.com'
  };