...
export const environment = {
    ...
    apiUrl: 'https://converter-round-validity-edt.trycloudflare.com/api', // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://converter-round-validity-edt.trycloudflare.com'
  };