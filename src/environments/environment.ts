...
export const environment = {
   ...
   apiUrl: 'https://scheduled-barrier-intersection-giant.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://scheduled-barrier-intersection-giant.trycloudflare.com',
