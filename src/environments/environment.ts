...
export const environment = {
    ...
    apiUrl: 'https://scene-outside-standards-entries.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://scene-outside-standards-entries.trycloudflare.com'
  };