...
export const environment = {
   ...
   apiUrl: 'https://wine-portfolio-pages-compliant.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://wine-portfolio-pages-compliant.trycloudflare.com',
