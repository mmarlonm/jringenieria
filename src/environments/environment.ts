...
export const environment = {
    ...
    apiUrl: 'https://ann-housing-tags-casey.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://ann-housing-tags-casey.trycloudflare.com'
  };