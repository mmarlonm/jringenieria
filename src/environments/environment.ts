...
export const environment = {
   ...
   apiUrl: 'https://workstation-builder-doom-britney.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://workstation-builder-doom-britney.trycloudflare.com'
  };