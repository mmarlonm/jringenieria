...
export const environment = {
    ...
    apiUrl: 'https://anyway-realm-arlington-surplus.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://anyway-realm-arlington-surplus.trycloudflare.com'
  };