...
export const environment = {
    ...
    apiUrl: 'https://solid-intense-submission-developed.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://solid-intense-submission-developed.trycloudflare.com'
  };