...
export const environment = {
    ...
    apiUrl: 'https://se-pediatric-kenny-webpage.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://se-pediatric-kenny-webpage.trycloudflare.com'
  };