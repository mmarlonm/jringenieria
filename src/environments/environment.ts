...
export const environment = {
    ...
    apiUrl: 'https://steps-saw-personnel-reductions.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://steps-saw-personnel-reductions.trycloudflare.com'
  };