...
export const environment = {
   ...
   apiUrl: ' https://olympic-lol-benz-subjective.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: ' https://olympic-lol-benz-subjective.trycloudflare.com'
  };