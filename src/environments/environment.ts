...
export const environment = {
   ...
   apiUrl: 'https://tribune-techno-thing-decades.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://tribune-techno-thing-decades.trycloudflare.com'
  };