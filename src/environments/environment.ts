...
export const environment = {
   ...
   apiUrl: 'https://guide-dna-linear-equality.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://guide-dna-linear-equality.trycloudflare.com',
