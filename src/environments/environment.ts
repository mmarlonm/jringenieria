...
export const environment = {
    ...
    apiUrl: 'https://throw-structure-reflect-surname.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://throw-structure-reflect-surname.trycloudflare.com'
  };