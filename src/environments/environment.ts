...
export const environment = {
   ...
   apiUrl: 'https://tractor-rj-hostel-sk.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://tractor-rj-hostel-sk.trycloudflare.com'
  };