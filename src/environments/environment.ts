...
export const environment = {
   ...
   apiUrl: 'https://intellectual-telecharger-administration-riverside.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://intellectual-telecharger-administration-riverside.trycloudflare.com',
