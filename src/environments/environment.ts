...
export const environment = {
    ...
    apiUrl: 'https://updating-characterized-island-std.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://updating-characterized-island-std.trycloudflare.com'
  };