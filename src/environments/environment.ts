...
export const environment = {
   ...
   apiUrl: 'https://protocols-whats-switching-determined.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://protocols-whats-switching-determined.trycloudflare.com'
  };