...
export const environment = {
   ...
   apiUrl: 'https://assumption-hart-adjustments-cyber.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://assumption-hart-adjustments-cyber.trycloudflare.com'
  };