...
export const environment = {
    ...
    apiUrl: 'https://tech-surfaces-unix-michelle.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://tech-surfaces-unix-michelle.trycloudflare.com'
  };