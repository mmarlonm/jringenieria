...
export const environment = {
   ...
   apiUrl: 'https://five-kelkoo-soma-sea.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://five-kelkoo-soma-sea.trycloudflare.com',
