...
export const environment = {
   ...
   apiUrl: 'https://chance-robots-brakes-ate.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://chance-robots-brakes-ate.trycloudflare.com'
  };