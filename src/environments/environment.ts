...
export const environment = {
   ...
   apiUrl: 'https://brick-firm-dosage-crazy.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://brick-firm-dosage-crazy.trycloudflare.com'
  };