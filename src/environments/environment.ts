...
export const environment = {
    ...
    apiUrl: 'https://confusion-tx-sponsored-developed.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://confusion-tx-sponsored-developed.trycloudflare.com'
  };