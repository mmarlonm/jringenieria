...
export const environment = {
    ...
    apiUrl: 'https://entertaining-man-astrology-jamie.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://entertaining-man-astrology-jamie.trycloudflare.com'
  };