...
export const environment = {
   ...
   apiUrl: 'https://tire-rachel-trembl-pairs.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://tire-rachel-trembl-pairs.trycloudflare.com',
