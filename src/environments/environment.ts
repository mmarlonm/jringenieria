...
export const environment = {
    ...
    apiUrl: 'https://kerry-checkout-partnership-gig.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://kerry-checkout-partnership-gig.trycloudflare.com'
  };