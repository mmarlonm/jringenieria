...
export const environment = {
    ...
    apiUrl: 'https://august-availability-ward-retain.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://august-availability-ward-retain.trycloudflare.com'
  };