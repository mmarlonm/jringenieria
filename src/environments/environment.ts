...
export const environment = {
   ...
   apiUrl: 'https://scripting-andy-lake-oz.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://scripting-andy-lake-oz.trycloudflare.com'
  };