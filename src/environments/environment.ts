...
export const environment = {
   ...
   apiUrl: 'https://villages-deemed-outcomes-fitted.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://villages-deemed-outcomes-fitted.trycloudflare.com'
  };