...
export const environment = {
    ...
    apiUrl: 'https://earning-obesity-disputes-utilize.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://earning-obesity-disputes-utilize.trycloudflare.com'
  };