...
export const environment = {
    ...
    apiUrl: 'https://wash-marsh-pit-plays.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://wash-marsh-pit-plays.trycloudflare.com'
  };