...
export const environment = {
    ...
    apiUrl: 'https://ensure-technology-achievement-mpeg.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://ensure-technology-achievement-mpeg.trycloudflare.com'
  };