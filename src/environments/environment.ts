...
export const environment = {
    ...
    apiUrl: 'https://var-bibliographic-worker-yards.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://var-bibliographic-worker-yards.trycloudflare.com'
  };