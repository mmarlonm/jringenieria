...
export const environment = {
   ...
   apiUrl: 'https://medium-youth-power-tin.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://medium-youth-power-tin.trycloudflare.com',
