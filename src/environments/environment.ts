...
export const environment = {
   ...
   apiUrl: 'https://respectively-beads-randy-thickness.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://respectively-beads-randy-thickness.trycloudflare.com',
