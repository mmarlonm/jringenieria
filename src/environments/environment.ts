...
export const environment = {
   ...
   apiUrl: 'https://village-vary-optimum-masters.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://village-vary-optimum-masters.trycloudflare.com'
  };