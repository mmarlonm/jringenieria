...
export const environment = {
    ...
    apiUrl: 'https://douglas-touring-wind-discount.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://douglas-touring-wind-discount.trycloudflare.com'
  };