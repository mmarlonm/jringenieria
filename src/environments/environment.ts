...
export const environment = {
   ...
   apiUrl: 'https://unlikely-might-philippines-pursue.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://unlikely-might-philippines-pursue.trycloudflare.com'
  };