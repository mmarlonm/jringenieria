...
export const environment = {
    ...
    apiUrl: 'https://qui-boc-wing-iron.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://qui-boc-wing-iron.trycloudflare.com'
  };