...
export const environment = {
    ...
    apiUrl: 'https://collect-hawaiian-destruction-raymond.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://collect-hawaiian-destruction-raymond.trycloudflare.com'
  };