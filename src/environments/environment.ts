...
export const environment = {
   ...
   apiUrl: 'https://mg-impressed-ruling-flex.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://mg-impressed-ruling-flex.trycloudflare.com'
  };