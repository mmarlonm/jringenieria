...
export const environment = {
   ...
   apiUrl: 'https://seem-sons-troy-hawaiian.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://seem-sons-troy-hawaiian.trycloudflare.com'
  };