...
export const environment = {
   ...
   apiUrl: 'https://entrepreneurs-bucks-arts-tgp.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://entrepreneurs-bucks-arts-tgp.trycloudflare.com'
  };