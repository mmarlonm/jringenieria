...
export const environment = {
    ...
    apiUrl: 'https://small-threatening-agency-airports.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://small-threatening-agency-airports.trycloudflare.com'
  };