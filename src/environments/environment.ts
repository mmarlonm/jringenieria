...
export const environment = {
    ...
    apiUrl: 'https://tomatoes-recipe-graham-divisions.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://tomatoes-recipe-graham-divisions.trycloudflare.com'
  };