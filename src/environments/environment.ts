...
export const environment = {
    ...
    apiUrl: 'https://feeding-certificate-intersection-authority.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://feeding-certificate-intersection-authority.trycloudflare.com'
  };