...
export const environment = {
   ...
   apiUrl: 'https://extreme-coral-hosting-nearest.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://extreme-coral-hosting-nearest.trycloudflare.com'
  };