...
export const environment = {
   ...
   apiUrl: 'https://eye-ohio-inches-tampa.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://eye-ohio-inches-tampa.trycloudflare.com',
