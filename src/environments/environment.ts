...
export const environment = {
    ...
    apiUrl: 'https://stay-patent-advertiser-contributor.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://stay-patent-advertiser-contributor.trycloudflare.com'
  };