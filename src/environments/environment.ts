...
export const environment = {
   ...
   apiUrl: 'https://voip-desert-representing-private.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://voip-desert-representing-private.trycloudflare.com'
  };