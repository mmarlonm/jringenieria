...
export const environment = {
   ...
   apiUrl: 'https://harvest-lawn-advantage-actually.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://harvest-lawn-advantage-actually.trycloudflare.com',
