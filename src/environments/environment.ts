...
export const environment = {
    ...
    apiUrl: 'https://soonest-engage-pants-scheduling.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://soonest-engage-pants-scheduling.trycloudflare.com'
  };