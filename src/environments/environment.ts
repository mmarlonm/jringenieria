...
export const environment = {
   ...
   apiUrl: 'https://wayne-selective-genetic-setup.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://wayne-selective-genetic-setup.trycloudflare.com'
  };