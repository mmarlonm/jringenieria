...
export const environment = {
    ...
    apiUrl: 'https://drawing-wrestling-yoga-frontpage.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://drawing-wrestling-yoga-frontpage.trycloudflare.com'
  };