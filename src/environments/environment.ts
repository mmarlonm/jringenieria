...
export const environment = {
   ...
   apiUrl: 'https://io-compaq-rd-household.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://io-compaq-rd-household.trycloudflare.com'
  };