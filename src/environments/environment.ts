...
export const environment = {
    ...
    apiUrl: 'https://lace-slot-oils-flat.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://lace-slot-oils-flat.trycloudflare.com'
  };