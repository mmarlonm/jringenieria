...
export const environment = {
    ...
    apiUrl: 'https://dg-parent-align-decided.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://dg-parent-align-decided.trycloudflare.com'
  };