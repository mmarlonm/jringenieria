...
export const environment = {
    ...
    apiUrl: 'https://highway-exclusive-annoying-supported.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://highway-exclusive-annoying-supported.trycloudflare.com'
  };