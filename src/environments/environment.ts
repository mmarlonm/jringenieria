...
export const environment = {
   ...
   apiUrl: 'https://peripherals-folk-ranger-goto.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://peripherals-folk-ranger-goto.trycloudflare.com'
  };