...
export const environment = {
    ...
    apiUrl: 'https://education-tm-junk-cocktail.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://education-tm-junk-cocktail.trycloudflare.com'
  };