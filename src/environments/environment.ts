...
export const environment = {
    ...
    apiUrl: 'https://jobs-nicaragua-thirty-exactly.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://jobs-nicaragua-thirty-exactly.trycloudflare.com'
  };