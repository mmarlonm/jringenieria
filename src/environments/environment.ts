...
export const environment = {
    ...
    apiUrl: 'https://deutsche-these-known-shops.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://deutsche-these-known-shops.trycloudflare.com'
  };