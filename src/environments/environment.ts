...
export const environment = {
    ...
    apiUrl: 'https://hist-tahoe-additional-conclusions.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://hist-tahoe-additional-conclusions.trycloudflare.com'
  };