...
export const environment = {
    ...
    apiUrl: 'https://st-juice-being-dos.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://st-juice-being-dos.trycloudflare.com'
  };