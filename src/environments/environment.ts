...
export const environment = {
   ...
   apiUrl: 'https://anderson-danny-wheat-achievement.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://anderson-danny-wheat-achievement.trycloudflare.com'
  };