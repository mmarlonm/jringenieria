...
export const environment = {
   ...
   apiUrl: 'https://incoming-fax-arab-dried.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://incoming-fax-arab-dried.trycloudflare.com'
  };