...
export const environment = {
   ...
   apiUrl: 'https://regulations-charlie-cooper-very.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://regulations-charlie-cooper-very.trycloudflare.com',
