...
export const environment = {
    ...
    apiUrl: 'https://patterns-pub-missing-postcard.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://patterns-pub-missing-postcard.trycloudflare.com'
  };