...
export const environment = {
    ...
    apiUrl: 'https://plaza-eternal-linux-ping.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://plaza-eternal-linux-ping.trycloudflare.com'
  };