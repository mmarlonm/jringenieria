...
export const environment = {
    ...
    apiUrl: 'https://door-indiana-swim-lawn.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://door-indiana-swim-lawn.trycloudflare.com'
  };