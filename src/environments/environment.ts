...
export const environment = {
   ...
   apiUrl: 'https://distance-ball-combine-faculty.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://distance-ball-combine-faculty.trycloudflare.com',
