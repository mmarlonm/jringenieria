...
export const environment = {
    ...
    apiUrl: 'https://princess-vacation-vault-findarticles.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://princess-vacation-vault-findarticles.trycloudflare.com'
  };