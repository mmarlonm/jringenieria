...
export const environment = {
    ...
    apiUrl: 'https://adjustable-jurisdiction-jeremy-invoice.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://adjustable-jurisdiction-jeremy-invoice.trycloudflare.com'
  };