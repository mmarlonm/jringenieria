...
export const environment = {
    ...
    apiUrl: 'https://beneficial-imagination-times-darkness.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://beneficial-imagination-times-darkness.trycloudflare.com'
  };