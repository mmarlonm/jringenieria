...
export const environment = {
   ...
   apiUrl: 'https://beatles-russia-ms-bureau.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://beatles-russia-ms-bureau.trycloudflare.com'
  };