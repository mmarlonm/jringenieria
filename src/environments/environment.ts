...
export const environment = {
   ...
   apiUrl: 'https://scholarships-factor-merit-butterfly.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://scholarships-factor-merit-butterfly.trycloudflare.com',
