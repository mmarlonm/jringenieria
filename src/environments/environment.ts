...
export const environment = {
    ...
    apiUrl: 'https://treat-hopefully-then-sc.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://treat-hopefully-then-sc.trycloudflare.com'
  };