...
export const environment = {
   ...
   apiUrl: 'https://speed-educated-macro-denied.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://speed-educated-macro-denied.trycloudflare.com',
