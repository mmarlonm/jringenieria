...
export const environment = {
   ...
   apiUrl: 'https://many-cleaners-hz-granny.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://many-cleaners-hz-granny.trycloudflare.com'
  };