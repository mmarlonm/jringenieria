...
export const environment = {
   ...
   apiUrl: 'https://stud-treated-aid-hire.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://stud-treated-aid-hire.trycloudflare.com'
  };