...
export const environment = {
    production: false,
    apiUrl: 'https://localhost:63318/api',  // Aquí va la URL de tu API (ajusta según sea necesario)
    apiUrlSignal: 'https://localhost:63318',  // chat real time
    ...
    //apiUrlSignal: 'https://localhost:63318',
