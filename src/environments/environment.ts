...
export const environment = {
    ...
    apiUrl: 'https://ph-bulk-com-concept.trycloudflare.com/api', // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://ph-bulk-com-concept.trycloudflare.com'
  };