...
export const environment = {
    ...
    apiUrl: 'https://spam-grip-researchers-fixed.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://spam-grip-researchers-fixed.trycloudflare.com'
  };