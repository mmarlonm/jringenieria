...
export const environment = {
    ...
    apiUrl: 'https://films-evaluate-pulled-turkey.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://films-evaluate-pulled-turkey.trycloudflare.com'
  };