...
export const environment = {
   ...
   apiUrl: 'https://confused-usd-fair-porter.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://confused-usd-fair-porter.trycloudflare.com'
  };