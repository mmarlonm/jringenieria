...
export const environment = {
   ...
   apiUrl: 'https://creek-remain-clinton-speak.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://creek-remain-clinton-speak.trycloudflare.com'
  };