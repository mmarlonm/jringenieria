...
export const environment = {
    ...
    apiUrl: 'https://expansys-bar-mh-classified.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://expansys-bar-mh-classified.trycloudflare.com'
  };