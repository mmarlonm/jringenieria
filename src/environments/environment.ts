...
export const environment = {
    ...
    apiUrl: 'https://geological-wan-phone-temperatures.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://geological-wan-phone-temperatures.trycloudflare.com'
  };