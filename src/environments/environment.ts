...
export const environment = {
    ...
    apiUrl: 'https://reply-brokers-encouraged-acrylic.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://reply-brokers-encouraged-acrylic.trycloudflare.com'
  };