...
export const environment = {
    ...
    apiUrl: 'https://operated-poor-ripe-future.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://operated-poor-ripe-future.trycloudflare.com'
  };