...
export const environment = {
    ...
    apiUrl: 'https://mixed-ii-src-lowest.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://mixed-ii-src-lowest.trycloudflare.com'
  };