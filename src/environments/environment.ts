...
export const environment = {
   ...
   apiUrl: 'https://even-kidney-triumph-eau.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://even-kidney-triumph-eau.trycloudflare.com'
  };