...
export const environment = {
    ...
    apiUrl: 'https://composed-folders-frost-lightbox.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://composed-folders-frost-lightbox.trycloudflare.com'
  };