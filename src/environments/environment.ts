...
export const environment = {
   ...
   apiUrl: 'https://globe-plugin-visual-eva.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://globe-plugin-visual-eva.trycloudflare.com'
  };