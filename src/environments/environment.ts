...
export const environment = {
    ...
    apiUrl: 'https://boundaries-virginia-wp-underground.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
    apiUrlSignal: 'https://boundaries-virginia-wp-underground.trycloudflare.com'
  };