...
export const environment = {
   ...
   apiUrl: 'https://lyric-transcription-lanes-subsection.trycloudflare.com/api',  // Aquí va la URL de tu API (ajusta según sea necesario) 
   apiUrlSignal: 'https://lyric-transcription-lanes-subsection.trycloudflare.com',
